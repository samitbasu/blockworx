...
fn rounded_pentagon(
    ...
    painter.add_convex_polygon(points, fill, stroke);
}
...
pub fn draw_box_outline(
    ...
    if let Some(side) = port_side {
        ...
        rounded_pentagon(&vertices, 3.0, fill, stroke, painter);
    } else {
        painter.rect(bbox, 3.0, fill, stroke);
    }
}
...
pub fn draw_pin(
    ...
    painter.rect_stroke(bbox, 1.0, (0.5, Color32::DARK_BLUE));
}
...
pub fn draw_control_frame(
    ...
    draw_box_outline(
        ...
        port_side,
        Color32::TRANSPARENT,
        Stroke::new(0.5, painter.theme().selection_frame),
        painter,
    );
    for &mode in resize_modes {
        ...
        painter.rect(
            ...
            0.0,
            painter.theme().control_handle_fill,
    ...
    for &pin_pos in [add_pin_east, add_pin_west].iter().flatten() {
        ...
        painter.line_segment(
            ...
            (1.0, painter.theme().control_handle_stroke),
        );
        painter.line_segment(
            [
...
impl RenderedPath {
    pub fn render(&self, painter: &mut Painter, stroke: impl Into<Stroke>) {
...
pub fn draw_block_title(bbox: Rect, title: &Title, painter: &mut Painter) {
    ...
    painter.text(
        ...
        painter.theme().shape_title,
    );
}

pub fn draw_block_frame(bbox: Rect, title: &Title, painter: &mut Painter) {
    draw_box_outline(
        bbox,
        None,
